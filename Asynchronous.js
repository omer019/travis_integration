...
//	browser.manage().window().maximize(); 
	...
	baseUrl = "http://tools-stage.gapminderdev.org";
...
//********************************************************************************************							
	...
	it('GDP', function(){
	   ...
	   //Hovering USA bubble
   	   var USABubble =element(by.css("#vizabi-placeholder > div > div.vzb-tool-stage > div.vzb-tool-viz > div > svg > g > svg.vzb-bc-bubbles-crop > g.vzb-bc-bubbles > circle.vzb-bc-entity.bubble-usa"));
	   browser.actions().dragAndDrop(USABubble,{x:0,y:20}).perform();
			...
			secondDigit.getText().then(function (secondDigitAsParameter) {
				...
				thirdDigit.getText().then(function (thirdDigitAsParameter) {
					...
					fourthDigit.getText().then(function (fourthDigitAsParameter) {
						...
						// Clicking X and Y
						var XandY = browser.element(by.css("#vizabi-placeholder > div > div.vzb-tool-sidebar > div.vzb-tool-dialogs > div.vzb-top-dialog.vzb-dialogs-dialog.vzb-popup.vzb-active.notransition > div > div.vzb-dialog-content.vzb-dialog-scrollable.vzb-accordion > div:nth-child(4) > div > div.vzb-dialog-title > span"));
